...
Lesson18::Lesson18(int viewportWidth,int viewportHeight)
...
//    _frameBuffer = new ayy::AYYFrameBuffer(GetViewportWidth(),GetViewportHeight());
    ...
    _mainBoxShader = ayy::Util::CreateShaderWithFile("res/lesson18_reflect.vs","res/lesson18_reflect.fs");
    ...
    // main node
    _mainNode = new Lessin18ReflectNode();
...
void Lesson18::OnViewportSizeChanged(int width,int height)
{
...
void Lesson18::Prepare2DTexture()
{
...
void Lesson18::PrepareCubeTexture()
{
...
void Lesson18::HandleKeyboardInput(GLFWwindow* window)
{
