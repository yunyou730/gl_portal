...
void Lesson14::Prepare()
{
    ...
    _modelShader = ayy::Util::CreateShaderWithFile("res/ayy_model.vs","res/ayy_model.fs");
...
void Lesson14::HandleKeyboardInput(GLFWwindow* window)
{
    // handle camera move
